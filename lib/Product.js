...
class ProductInventoryError extends base.BaseResponse {
...
class ProductInventoryUpdateResponse extends base.BaseResponse {
    constructor(products, error) {
        ...
        if(!(products[0] instanceof ProductInventoryError)){
            throw "products must be type of ProductInventoryError[]";
        }
